 ...
 create table card (id uuid not null, answer varchar(255), question varchar(255), user_id uuid, next_practice_time timestamp, last_time_easy timestamp, consecutive_correct_answer int4, primary key (id));
 ...
 create table session (id uuid not null, user_id uuid not null, start_time timestamp, finish_time timestamp, is_Active boolean, pack_id uuid, last_card_id uuid, primary key (id));
