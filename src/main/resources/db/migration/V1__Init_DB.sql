 ...
 create table card_in_pack (pack_id uuid not null, card_id uuid not null);
 ...
 create table tag_to_pack (pack_id uuid not null, tag_id uuid not null);
 create table user_role (user_id uuid not null, roles varchar(255));
 create table user_session (session_id uuid not null, user_id uuid not null);
 ...
 create table usr_packs (pack_id uuid not null, usr_id uuid not null);
