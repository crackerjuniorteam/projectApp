...
public class SessionDTO {
    ...
    public SessionDTO(String question, String answer, UUID session_id, UUID pack_id, UUID card_id, boolean isActive, Integer cardsToRepeat) {
    ...
    public Integer getCardsToRepeat() {
        return cardsToRepeat;
    }

    public void setCardsToRepeat(Integer cardsToRepeat) {
        this.cardsToRepeat = cardsToRepeat;
    }
}
